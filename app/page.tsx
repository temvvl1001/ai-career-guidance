      ...
      <main className="pt-16 min-h-screen">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-dark-300 mb-10 animate-slide-up">
                Take our personality test, get AI-powered career recommendations,
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="p-6 rounded-2xl bg-dark-800/50 border border-dark-600 hover:border-accent-purple/50 transition-all group">
                ...
                <h3 className="text-lg font-semibold mb-2">Personality Test</h3>
                <p className="text-dark-400 text-sm">
                  Take our MBTI-style assessment to discover your unique
              ...
              <div className="p-6 rounded-2xl bg-dark-800/50 border border-dark-600 hover:border-accent-purple/50 transition-all group">
                ...
                <h3 className="text-lg font-semibold mb-2">Career Match</h3>
                <p className="text-dark-400 text-sm">
              ...
              <div className="p-6 rounded-2xl bg-dark-800/50 border border-dark-600 hover:border-accent-purple/50 transition-all group">
                ...
                <h3 className="text-lg font-semibold mb-2">AI Roadmap</h3>
                <p className="text-dark-400 text-sm">
        ...
        <footer className="py-12 border-t border-dark-700">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-dark-400 text-sm">
            <p>© 2025 AI Career Guidance Platform. Built with Next.js & Gemini AI.</p>
          </div>
        </footer>
      </main>
